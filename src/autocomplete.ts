...
export class TestCompletionItemProvider implements vscode.CompletionItemProvider {
    ...
    return new Promise<vscode.CompletionList>((resolve, reject) => {
      resolve(
        new vscode.CompletionList(
          keywords.map((keyword) => new vscode.CompletionItem(keyword, vscode.CompletionItemKind.Function)),
          true
        )
      );
    });
